...
alias lg="lazygit"
alias cat="bat"
alias ls="eza -1 --icons=auto --hyperlink=auto"
alias ll="eza -lh --icons=auto --sort=name --group-directories-first --hyperlink=auto"
alias la="eza -lha --icons=auto --sort=name --group-directories-first --hyperlink=auto"
alias cd="z"
